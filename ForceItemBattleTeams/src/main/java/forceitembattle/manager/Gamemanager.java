...
public class Gamemanager {
    ...
    public void startGame(CommandSender sender) {
        try {
            ...
            Main.getInstance().logToFile("The game was started with " + num + " jokers. " + Main.getInstance().getConfig().getInt("standard.countdown") + " minutes left.");
            ...
            if (Main.getInstance().getConfig().getBoolean("settings.isTeamGame")) Main.getBackpack().addToAllBp(stack);
            Bukkit.getWorld("world").setTime(0);
            Main.getTimer().setRunning(true);

            Bukkit.broadcastMessage(ChatColor.GOLD + "The game was started with " + num + " jokers. " + Main.getInstance().getConfig().getInt("standard.countdown") + " minutes left.");
